...
export default async function AdminDashboardPage() {
  ...
  const [customers, owners, admins, activeUsers, suspendedUsers, approvedHotels, suspendedHotels, undecidedHotels, totalBookings, activeBookings, hiddenReviews, refundPendingPayments, recentBookings] = await Promise.all([
